...
class AnimatedGif(tk.Label):
	...
	def _animate(self):
		try:
			...
			self._num += 1
		except tk.TclError:  # When we try a matrix_frame that doesn't exist, we know we have to start over from zero
			self._num = 0
